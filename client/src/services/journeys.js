...
const getJourneys = async (offset, limit, order,filterByDistance, filterByDuration) => {
    ...
    const res = await axios.get(`${baseUrl}?offset=${offset}&limit=${limit}&order=${order}&filterByDistance=${filterByDistance}&filterByDuration=${filterByDuration}`);
    return res.data
}
